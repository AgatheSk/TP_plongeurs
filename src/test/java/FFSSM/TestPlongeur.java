...
public class TestPlongeur {	
	...
	public void setUp() {
        ...
        public void TestAjoutLicence(){
            ...
            //assertEquals(l1, p.licences.get(0),"La licence n'a pas été bien ajoutée");
            assertEquals(l1.getNumero(), p.licences.get(0).getNumero(),"La licence n'a pas été bien ajoutée");
        }
